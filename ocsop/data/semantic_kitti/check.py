...
from ocsop.data.semantic_kitti.kitti_dataset import KittiDataset
import time
import threading
import functools
split = 'val'
dataset_1 = KittiDataset(
    split=split,
    root='/root/autodl-tmp/DATA/ocsop_SemanticKitti',
    preprocess_root='/root/autodl-tmp/DATA/ocsop_SemanticKitti/preprocess',
    frustum_size=8,
    fliplr=0.5,
