...
result_path = '/root/autodl-tmp/ocsop_dev_coord/ocsop/exp/kitti_lr_0.1_1_xybr_1/output_base/kitti/08/*.pkl'
# result_path = '/root/autodl-tmp/ocsop_dev/ocsop/exp/exp_1/output/NYU/*.pkl'
# result_path = '/root/autodl-tmp/ocsop_dev_coord/ocsop/exp/trial_new_cpr_1/output/NYU/*.pkl'
